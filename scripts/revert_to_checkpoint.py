...
print("=== REVERTING ALL JSON DATABASES TO CHECKPOINT STATE ===")
...
# Filter and verify updates using safe similarity thresholds
...
# Specific manual verified entries
verified_name_updates = {
    '38201-1158228-1': {'NameUrdu': 'محمد سعید', 'FatherNameUrdu': 'محمد اسماعیل مرحوم مفتى دا'},
    '38201-3815683-8': {'NameUrdu': 'سعید علی', 'FatherNameUrdu': 'زوجہ ایاز احمد خان'},
    '38201-9495135-4': {'NameUrdu': 'نفیسہ جمال', 'FatherNameUrdu': 'زوجہ محمد فیصل'}
}

for scnic, updates in verified_name_updates.items():
    if scnic in json_map:
        json_map[scnic].update(updates)

print(f"Applied verified updates. Total records processed.")
...
print("REVERT AND SYNC COMPLETE!")
